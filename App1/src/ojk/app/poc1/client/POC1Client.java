...
public class POC1Client {
	...
	static final String endpoint = "http://hostdb/ESB/POC1Service";
	// static final String endpoint = "http://hostqm1:7080/ESB/POC1Service";
	...
	public static int sendData(String username, String passwordStr,
			String operation, String IDTransaksi, String FullName,
