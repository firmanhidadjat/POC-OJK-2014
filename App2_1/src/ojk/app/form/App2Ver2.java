...
@ManagedBean(name = "App2Ver2")
// @RequestScoped
@ViewScoped
public class App2Ver2 implements Serializable {
	static Logger log = LoggerUtil.getLog();
	private POC2Ver2 selectedPOC;
	private List<POC2Ver2> pocs = new ArrayList<POC2Ver2>();
	...
	public List<POC2Ver2> getPocs() {
		return pocs;
	}

	public void setPocs(List<POC2Ver2> pocs) {
		this.pocs = pocs;
	}

	public POC2Ver2 getSelectedPOC() {
		return selectedPOC;
	}

	public void setSelectedPOC(POC2Ver2 selectedPOC) {
