...
public class POC2Client {
	...
	public int sendData(String username, String passwordStr, String operation,
			String TransactionID, String FirstName, String LastName,
			String Notes, String Status, String TransactionValue,
			String ApprovedAmount, String Pin) throws Exception {
	...
	public static POC2Ver2 getObj(SOAPMessage soapResponse) throws Exception {
		Node dataBody = soapResponse.getSOAPPart().getEnvelope().getBody()
		...
		if (dataBody == null) {
			...
			JAXBContext jc = JAXBContext.newInstance(POC2Ver2.class);
			Unmarshaller unmarshaller = jc.createUnmarshaller();
			JAXBElement<POC2Ver2> je = unmarshaller.unmarshal(dataBody,
					POC2Ver2.class);
			return je.getValue();
		}
	}
