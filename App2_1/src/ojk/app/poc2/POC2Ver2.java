...
@XmlType(propOrder = { "TransactionID", "FirstName", "LastName", "Notes",
		"Status", "TransactionValue", "ApprovedAmount", "Pin", "OriginalAmount" })
public class POC2Ver2 implements Serializable {
	...
	public POC2Ver2(BigDecimal TransactionID, String FirstName,
